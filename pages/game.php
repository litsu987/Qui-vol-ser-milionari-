    ...
    function obtenerArchivoSegunDificultad($nivelDificultad)
    {
        ...
        if ($_SESSION['lang'] == 'ca') {
            $archivosPorDificultad = [
                1 => 'questions/catalan_1.txt',
                // Archivo para nivel de dificultad 1
                2 => 'questions/catalan_2.txt',
                // Archivo para nivel de dificultad 2
                3 => 'questions/catalan_3.txt',
                // Archivo para nivel de dificultad 3
                4 => 'questions/catalan_4.txt',
                // Archivo para nivel de dificultad 4
                5 => 'questions/catalan_5.txt',
                // Archivo para nivel de dificultad 5
                6 => 'questions/catalan_6.txt',
                // Archivo para nivel de dificultad 6
            ];
        } else if ($_SESSION['lang'] == 'es') {
            $archivosPorDificultad = [
                1 => 'questions/spanish_1.txt',
                // Archivo para nivel de dificultad 1
                2 => 'questions/spanish_2.txt',
                // Archivo para nivel de dificultad 2
                3 => 'questions/spanish_3.txt',
                // Archivo para nivel de dificultad 3
                4 => 'questions/spanish_4.txt',
                // Archivo para nivel de dificultad 4
                5 => 'questions/spanish_5.txt',
                // Archivo para nivel de dificultad 5
                6 => 'questions/spanish_6.txt',
                // Archivo para nivel de dificultad 6
            ];
        } else if ($_SESSION['lang'] == 'en') {
            $archivosPorDificultad = [
                1 => 'questions/english_1.txt',
                // Archivo para nivel de dificultad 1
                2 => 'questions/english_2.txt',
                // Archivo para nivel de dificultad 2
                3 => 'questions/english_3.txt',
                // Archivo para nivel de dificultad 3
                4 => 'questions/english_4.txt',
                // Archivo para nivel de dificultad 4
                5 => 'questions/english_5.txt',
                // Archivo para nivel de dificultad 5
                6 => 'questions/english_6.txt',
                // Archivo para nivel de dificultad 6
            ];
        }
